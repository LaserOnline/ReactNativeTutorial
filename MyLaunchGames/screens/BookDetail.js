            ...
            <View style={{ flex: 1 }}>
                ...
                <View style={{ flexDirection: 'row', paddingHorizontal: SIZES.radius, height: 80, alignItems: 'flex-end' }}>
                    ...
                    <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
                        <Text style={{ ...FONTS.h3, color: book.navTintColor }}>Store Games</Text>
                    </View>
                ...
                >
                    ...
                    <View style={{ flex: 1, alignItems: 'center' }}>
                        ...
                        <Text style={{ ...FONTS.body4, color: COLORS.white }}>คะแนน</Text>
                    </View>
                    ...
                    <View style={{ flex: 1, paddingHorizontal: SIZES.radius, alignItems: 'center' }}>
                        ...
                        <Text style={{ ...FONTS.body4, color: COLORS.white }}>คน</Text>
                    </View>
                    ...
                    <View style={{ flex: 1, alignItems: 'center' }}>
                        ...
                        <Text style={{ ...FONTS.body4, color: COLORS.white }}>ภาษารองรับ</Text>
                    </View>
                </View>
            </View>
        )
    ...
    function renderBookDescription() {
        ...
        return (
            <View style={{ flex: 1, flexDirection: 'row', padding: SIZES.padding }}>
                ...
                >
                    <Text style={{ ...FONTS.h2, color: COLORS.white, marginBottom: SIZES.padding }}>เนื้อเรื่อง</Text>
    ...
    function renderBottomButton() {
        return (
            <View style={{ flex: 1, flexDirection: 'row' }}>
                ...
                >
                    <Text style={{ ...FONTS.h3, color: COLORS.white }}>ซื้อ!!</Text>
                </TouchableOpacity>
            </View>
        )
    }
